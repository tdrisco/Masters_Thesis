...
from MID_Codes import MID, OutputMode, OutputSettings, MTException, Baudrates

from MID_Codes import XDIType, XDIDataId, getMIDName, DeviceState, DeprecatedMID

from MID_Codes import MTTimeoutException, SyncSetting, MTErrorMessage
...
class MTDevice(object):
    ...
    def __init__(self, port, baudrate=115200, timeout=0.002,  # Timeout needs to be adjusted 0.02 is much more effective than 0.2
